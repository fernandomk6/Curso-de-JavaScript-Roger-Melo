...
const myFavoriteTVShows = ['Supernatural', 'Spongebob', 'Apocalipse']
const sentence = `Minhas 3 séries favoritas são: ${myFavoriteTVShows.pop()}, ${myFavoriteTVShows.join(' e ')}.`
...
// console.log(myFavoriteTVShows.length === 3)
...
const crazyOperation = null + 1 // 1
const crazyConversion = Boolean(crazyOperation) // 1 is true

// console.log(crazyConversion) // true

// false e null, em operações matemáticas são convertidos para 0

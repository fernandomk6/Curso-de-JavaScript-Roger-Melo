...
const numberOfCrazyNumbers = crazyNumbers.reduce((accumulator, number) => {
  if (number < 501) accumulator++ 
...
const numbers = [5, 7, 3]
const numbersSquart = numbers.map(number => number ** 2)

// console.log(numbersSquart)
...
const logCarsName = cart.reduce((accumulator, game) => 
  accumulator += `- ${game.name} \n`, '')

// console.log(logCarsName)

...
const indexOfFevereiro = months.indexOf('Fevereiro')
// console.log(indexOfFevereiro)
...
const myBrithdayHour = myBrithday.getHours()
// console.log(myBrithdayHour)
...
const tomorrow = new Date(present.getTime() + oneDayMilliseconds)

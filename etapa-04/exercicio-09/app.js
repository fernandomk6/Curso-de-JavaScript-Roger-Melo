...
// console.log(convertToString([ 'marreco',  'amigo' ]))
/*
  02
...
*/
const getCharAmount = string => string.length

// console.log(getCharAmount('Fernando'))
/*
  03
...
// console.log(strToLower('CHOCOTONE E OVO DE PÁSCOA JUNTOS NO MERCADO EM PLENO FEVEREIRO'))
/*
  04
...
*/
const getIndexOf = (char, string) => string.indexOf(char)

// console.log(getIndexOf('f', 'fernando'))
/*
  05
...
const itemExist = (item, array) => array.includes(item)

// console.log(itemExist(1, [0, 2, 3]))
...
// console.log(concatArray(['Fernando', null, 0], [4, 5, 6]))
...
const removeTheLastItem = array => array.slice(0, array.length - 1)

// console.log(removeTheLastItem([1, 2, 3, 4]))
...
const getTriple = number => number * 3

const executeCallbackWith33AsArgument = callback => {
  const value = 33
  return callback(value)
}

const result = executeCallbackWith33AsArgument(getTriple)
// console.log(result)
...
const getLikesInfo = peoplesWhoLiked => {
  const peopleAmount = peoplesWhoLiked.length

  switch (peopleAmount) {
    case 0: 
      return 'Ninguém curtiu isso.'
    case 1:
      return `${peoplesWhoLiked[0]} curtiu isso.`
    case 2:
      return `${peoplesWhoLiked[0]} e ${peoplesWhoLiked[1]} curtiam isso.`
    case 3:
      return `${peoplesWhoLiked[0]}, ${peoplesWhoLiked[1]} e ${peoplesWhoLiked[2]} curtiam isso.`
    default:
      return `${peoplesWhoLiked[0]}, ${peoplesWhoLiked[1]} e mais ${peopleAmount - 2} pessoas curtiam isso.`
  }
}

// console.log(getLikesInfo(['fernando', 'jessica', 'rodrigo', 'jonathan', 'murial']))
